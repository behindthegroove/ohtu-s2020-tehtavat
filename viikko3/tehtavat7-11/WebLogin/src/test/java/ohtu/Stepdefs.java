...
public class Stepdefs {
    ...
    public void validUsernameAndPasswordAndPasswordConfirmationAreEntered(String username, String password) {
    ...
    public void tooShortUsernameAndValidPasswordAndPasswordConfirmationAreEntered(String username, String password) {
        createUserWith(username, password, password);
    }
    ...
    public void validUsernameAndTooShortPasswordAndMatchingConfirmationAreEntered(String username, String password) {
        createUserWith(username, password, password);
    }

    @When("a valid username {string} and password {string} and nonmatching password confirmation {string} are entered")
    public void validUsernameAndPasswordAndNonmatchingConfirmationAreEntered(String username, String password, String passwordConfirmation) {
